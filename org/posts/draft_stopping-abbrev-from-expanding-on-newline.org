...
previous abbrev should start at, otherwise it uses [[][Fbackward-word]].  This
suggests that what I need to do is provide a good regexp to determine.  The
comment in the code mentions [[][Vwords-include-escapes]].  I have got to say I
am not sure if I care about including escape sequences in words.
